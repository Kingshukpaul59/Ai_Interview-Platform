/*Here we have to convert the pdf data into AI readable format. */
import fs from "fs";
    ...
    const messages = [
      {
        ...
        content: `
            ...
            Rules:
            - "role": Identify the candidate's main job role or desired role.
            - "experience": Summarize the candidate's work experience.
            - "projects": Extract all important projects as an array of strings.
            - "skills": Extract all technical and relevant skills as an array of strings.
            - If any information is missing, return an empty string or empty array.
        `,
      },
      {
        role: "user",
...
export const generateQuestion = async (req, res) => {
  ...
  try {
    ...
    /*Prompt for AI how the questions will be generated.  */
    const userPrompt = `
    Role : ${role}
    ...
    if (!userPrompt.trim()) {
      return res.status(400).json({
        message: "Prompt contetn is empty.",
      });
    }
    const messages = [
      {
...
export const finishInterview = async (req, res) => {
  try {
    ...
    interview.questions.forEach((q) => {
      ...
      totalCommunication += q.communcation || 0;

        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            ...
            <select value ={mode} 
              ...
              className='w-full py-3 px-4 border border-gray-20 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'>
              ...
              whileHover={{scale : 1.03}}
              whileTap={{scale:0.95}}
              className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold transition duration-300 sahdow-md'>
                {loading ? "Startinng..." :" Start Interview"}

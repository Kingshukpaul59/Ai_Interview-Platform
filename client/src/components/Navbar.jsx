            ...
            >
                ...
                <div className='flex items-center gap-6 relative'>
                    ...
                    <div className='relative'>
                        ...
                        {showCreditPopup && (
                            <div className='absolute -right-50pxl mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                    ...
                    <div className='relative'>
                        ...
                        {showUserPopup && (
                            <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border-gray-200 rounded-xl p-4 z-50'>
                                ...
                                <button onClick={()=>navigate("/history")} className='w-full text-left text-sm py-2 hover:text-black text-gray-600'>Interview Histoy</button>
                                <button onClick={handleLogout} className='w-full text-left txt-sm py-2 flex items-center gap-2 text-red-500'>
